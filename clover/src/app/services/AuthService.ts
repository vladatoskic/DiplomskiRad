import { AdminApiAxiosParamCreator } from "@oryd/kratos-client";
import { KratosFormDetails } from "../entities/kratosForm/KratosFormDetails";


export default class KratosAuthService {
